...
const sequence_tree_builder_1 = require("../../src/utils/sequence-tree-builder");
describe('buildGraphFromSequence', () => {
    it('converts a flat sequence into a flat graph', () => {
        ...
        const graph = (0, sequence_tree_builder_1.buildTreeFromSequence)(sequence);
    ...
    it('handles an empty sequence', () => {
        const sequence = { name: 'Empty', steps: [] };
        const graph = (0, sequence_tree_builder_1.buildTreeFromSequence)(sequence);
